...
class InfrastructureService:
    ...
    def _determine_overall_status(self, services: list[ServiceStatus], db_status: DatabaseStatus, system_resources: SystemResources) -> str:
        ...
        if (system_resources.cpu_usage > 80 or 
            system_resources.memory_usage > 80 or 
            system_resources.disk_usage > 90):
            return "warning"
