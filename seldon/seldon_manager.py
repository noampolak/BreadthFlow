...
class SeldonManager:
    ...
    def deploy_model(self, model_name: str, model_version: str = "latest", replicas: int = 2) -> Dict[str, Any]:
        """
    ...
    def list_deployments(self) -> List[Dict[str, Any]]:
        ...
        """
        try:
            response = requests.get(f"{self.seldon_api_url}/api/v1/namespaces/{self.namespace}/seldondeployments")
    ...
    def delete_deployment(self, deployment_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code in [200, 404]:
                ...
                return {"status": "success", "message": f"Deployment {deployment_name} deleted"}
            else:
    ...
    def _load_deployment_template(self) -> Dict[str, Any]:
        ...
        if os.path.exists(template_path):
            ...
            return {
                ...
                "metadata": {"name": "breadthflow-trading", "namespace": "seldon-system"},
                "spec": {
    ...
    def _load_ab_test_template(self) -> Dict[str, Any]:
        ...
        if os.path.exists(template_path):
            ...
            return {
                "apiVersion": "machinelearning.seldon.io/v1",
                "kind": "SeldonDeployment",
                "metadata": {"name": "breadthflow-ab-test", "namespace": "seldon-system"},
                "spec": {
