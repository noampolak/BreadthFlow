...
class RiskManager(ABC):
    ...
    def calculate_position_size_limit(self, signal: Dict[str, Any],
                                    portfolio: PortfolioRecord,
                                    config: BacktestConfig) -> float:
    ...
    def check_drawdown_limit(self, portfolio: PortfolioRecord,
                           config: BacktestConfig) -> bool:
    ...
    def check_concentration_limit(self, portfolio: PortfolioRecord,
                                config: BacktestConfig) -> bool:
    ...
    def calculate_var(self, portfolio: PortfolioRecord,
    ...
    def calculate_expected_shortfall(self, portfolio: PortfolioRecord,
                                   confidence_level: float = 0.95) -> float:
