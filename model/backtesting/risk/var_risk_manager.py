...
class VaRRiskManager(RiskManager):
    ...
    def calculate_portfolio_risk(self, portfolio: PortfolioRecord,
        ...
        self.risk_stats['max_portfolio_risk'] = max(
            self.risk_stats['max_portfolio_risk'], portfolio_var
        )
    ...
    def _check_var_limits(self, trade: TradeRecord,
                         portfolio: PortfolioRecord,
                         config: BacktestConfig) -> bool:
        """Check VaR limits"""
    ...
    def _check_conditional_var_limits(self, trade: TradeRecord,
                                    portfolio: PortfolioRecord,
                                    config: BacktestConfig) -> bool:
    ...
    def _run_stress_tests(self, trade: TradeRecord,
                         portfolio: PortfolioRecord,
                         config: BacktestConfig) -> bool:
    ...
    def _calculate_parametric_var(self, weights: np.ndarray, 
    ...
    def _calculate_monte_carlo_var(self, weights: np.ndarray,
                                 volatilities: np.ndarray,
                                 correlation_matrix: np.ndarray) -> float:
    ...
    def get_var_report(self, portfolio: PortfolioRecord,
