...
class PerformanceAnalyzer:
    ...
    def add_portfolio_snapshot(self, portfolio: PortfolioRecord, timestamp: datetime):
        ...
        if len(self.equity_curve) > 1:
            ...
            if prev_value > 0:
                ...
                self.returns.append({"timestamp": timestamp, "return": daily_return})
    ...
    def _generate_drawdown_data(self) -> List[Dict[str, Any]]:
        ...
        for i, value in enumerate(equity_values):
            if value > peak:
                peak = value
            drawdown = (peak - value) / peak
            drawdown_data.append({"timestamp": timestamps[i].isoformat(), "drawdown": drawdown, "peak": peak, "value": value})
    ...
    def _calculate_performance_attribution(self) -> Dict[str, Any]:
        ...
        return {
            "factor_attribution": {"market_timing": 0.3, "stock_selection": 0.5, "risk_management": 0.2},
            "sector_attribution": {},
            "style_attribution": {},
        }
