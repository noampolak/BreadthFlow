...
class BaseBacktestEngine(BacktestEngineInterface):
    ...
    def _run_backtest_impl(self, signals: List[Dict[str, Any]], market_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _initialize_portfolio(self):
        ...
        if self.performance_analyzer:
            self.performance_analyzer.add_portfolio_snapshot(self.current_portfolio, self.current_portfolio.timestamp)
    ...
    def _run_backtest_loop(self, signals: List[Dict[str, Any]], market_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        results = {"trades": [], "portfolio_history": [], "performance_metrics": {}, "risk_metrics": {}}
    ...
    def _generate_trade_from_signal(self, signal: Dict[str, Any], market_data: Dict[str, Any]) -> Optional[TradeRecord]:
        ...
        if trade.trade_type == "BUY":
            if existing_position:
                ...
                existing_position.avg_price = (
                    existing_position.avg_price * existing_position.quantity + trade.price * trade.quantity
                ) / (existing_position.quantity + trade.quantity)
            else:
                # Create new position
