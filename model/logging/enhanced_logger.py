...
class EnhancedLogger:
    ...
    def log_operation(self, operation: str, data: Dict[str, Any] = None, level: str = "INFO"):
    ...
    def log_performance(self, operation: str):
        ...
        try:
            ...
            self.log_operation(
                f"{operation}_performance", {"duration_seconds": duration, "memory_delta_mb": memory_delta, "success": success}
            )
    ...
    def log_data_quality(self, data_source: str, quality_metrics: Dict[str, Any]):
        ...
        self.log_operation("data_quality_check", {"data_source": data_source, "quality_metrics": quality_metrics})

    def log_component_health(self, health_status: Dict[str, Any]):
        """Log component health status"""

        self.log_operation("component_health", health_status)
