...
class SignalGeneratorInterface(ABC):
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {"total_signals_generated": 0, "average_generation_time": 0.0, "success_rate": 1.0, "last_generation": None}
    ...
    def get_signal_quality_metrics(self, signals) -> Dict[str, Any]:
        ...
        if signals.empty:
            return {"total_signals": 0, "signal_strength_avg": 0.0, "confidence_avg": 0.0, "signal_distribution": {}}

        metrics = {"total_signals": len(signals), "signal_strength_avg": 0.0, "confidence_avg": 0.0, "signal_distribution": {}}
