...
class PipelineOrchestrator:
    ...
    def _initialize_components(self):
        ...
        try:
            ...
            self.data_fetcher = UniversalDataFetcher(
                config={"component_registry": self.component_registry}
            )
    ...
    async def _train_models(self, config: PipelineConfig, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            training_result = await self.training_manager.train_models(
                data=data,
                config=config.training_config or {}
            )
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'error_handler': {
                ...
                'recent_errors': len([e for e in self.error_handler.get_errors() if e.timestamp > datetime.now() - timedelta(hours=1)])
            },
