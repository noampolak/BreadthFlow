...
class DataSourceInterface(ABC):
    ...
    @abstractmethod
    def fetch_data(self, resource_name: str, symbols: List[str], start_date: datetime, end_date: datetime, **kwargs):
    ...
    def get_rate_limits(self) -> Dict[str, Any]:
        ...
        return {"requests_per_minute": 60, "requests_per_hour": 1000, "requests_per_day": 10000}

    def get_data_quality_info(self) -> Dict[str, Any]:
        """Get data quality information for this data source"""
        return {"completeness": 0.95, "accuracy": 0.98, "latency": "low", "update_frequency": "real_time"}
