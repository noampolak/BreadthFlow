...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('breadthflow_abstracted.log'),
...
def signals_generate(symbols, timeframe, strategy):
    ...
    try:
        ...
        # Convert to async execution
        result = asyncio.run(generate_signals_async(
            symbols=symbols.split(','),
...
def demo():
    ...
    try:
        ...
        data_result = asyncio.run(fetch_data_async(
            symbols=['AAPL', 'MSFT'],
            timeframe='1day',
            start_date='2024-01-01',
            end_date='2024-01-31',
        ...
        signal_result = asyncio.run(generate_signals_async(
            symbols=['AAPL', 'MSFT'],
            timeframe='1day',
            strategy='technical'
        ))
        ...
        backtest_result = asyncio.run(run_backtest_async(
            symbols=['AAPL', 'MSFT'],
            timeframe='1day',
            start_date='2024-01-01',
            end_date='2024-01-31',
