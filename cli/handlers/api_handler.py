...
class APIHandler:
    ...
    def serve_pipeline_runs_api(self):
        ...
        try:
            ...
            response_data = {
                "success": False,
                "error": f"Failed to get pipeline runs: {str(e)}"
            }
            return json.dumps(response_data), 'application/json', 500
    ...
    def serve_signals_latest_api(self):
        ...
        try:
            ...
            response_data = {
                "success": False,
                "error": f"Failed to get latest signals: {str(e)}"
            }
            return json.dumps(response_data), 'application/json', 500
    ...
    def serve_signals_export_api(self, path):
        ...
        try:
            ...
            response_data = {
                "success": False,
                "error": f"Failed to export signals: {str(e)}"
            }
            return json.dumps(response_data), 'application/json', 500
