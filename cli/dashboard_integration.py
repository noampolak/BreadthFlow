...
class DashboardIntegration:
    ...
    async def fetch_data(
        self, symbols: List[str], start_date: str, end_date: str, timeframe: str = "1day", data_source: str = "yfinance"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            config = PipelineConfig(
                ...
                backtest_config=BacktestConfig(
                    name="default_backtest", symbols=symbols, start_date=start_dt, end_date=end_dt, initial_capital=100000
                ),
            ...
            return {"success": False, "error": str(e), "symbols": symbols, "timeframe": timeframe, "data_source": data_source}
    ...
    async def generate_signals(
        ...
        try:
            ...
            return {"success": False, "error": str(e), "symbols": symbols, "timeframe": timeframe}

    async def run_backtest(
        self, symbols: List[str], from_date: str, to_date: str, timeframe: str = "1day", initial_capital: float = 100000
    ) -> Dict[str, Any]:
        """
    ...
    async def start_pipeline(
        ...
        try:
            ...
            return {"success": False, "error": str(e), "mode": mode, "timeframe": timeframe}
    ...
    async def stop_pipeline(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "pipelines_stopped": stopped_count, "total_running": len(running_executions)}
    ...
    async def get_pipeline_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "executions": {"total": len(all_executions), "by_status": status_counts},
    ...
    def get_system_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if status:
                ...
                return {"success": False, "error": "System status not available"}
...
async def fetch_data_async(
    symbols: List[str], start_date: str, end_date: str, timeframe: str = "1day", data_source: str = "yfinance"
) -> Dict[str, Any]:
...
async def generate_signals_async(
    symbols: List[str], start_date: str, end_date: str, timeframe: str = "1day"
) -> Dict[str, Any]:
...
async def run_backtest_async(
    symbols: List[str], from_date: str, to_date: str, timeframe: str = "1day", initial_capital: float = 100000
) -> Dict[str, Any]:
