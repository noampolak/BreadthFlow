...
class PipelineQueries:
    ...
    def get_pipeline_summary(self):
        ...
        try:
            if not self.db or not self.db.connection:
                ...
                return {"total_runs": 0, "success_rate": 0, "recent_runs": 0, "avg_duration": 0}
        ...
        try:
            ...
            if running_result:
                ...
                if last_run_result:
                    ...
                    return {"success": True, "status": {"state": "never_run", "last_run_time": None}}
    ...
    def start_pipeline(self, config):
        ...
        try:
            ...
            result = self.db.execute_query(insert_query, {"run_id": run_id, "command": command, "metadata": metadata})
