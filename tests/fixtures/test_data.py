...
class TestDataFactory:
    ...
    @staticmethod
    def create_ohlcv_data(symbols: List[str] = ["AAPL", "MSFT"], days: int = 30, start_date: datetime = None) -> pd.DataFrame:
    ...
    @staticmethod
    def create_signal_data(symbols: List[str] = ["AAPL", "MSFT"], days: int = 30, start_date: datetime = None) -> pd.DataFrame:
    ...
    @staticmethod
    def create_pipeline_run_data(symbols: List[str] = ["AAPL"], status: str = "running") -> Dict[str, Any]:
        ...
        return {
            ...
            "config": {"strategy": "technical", "parameters": {"rsi_period": 14, "macd_fast": 12, "macd_slow": 26}},
        }

    @staticmethod
    def create_backtest_data(symbols: List[str] = ["AAPL"], days: int = 30) -> Dict[str, Any]:
    ...
    @staticmethod
    def create_technical_indicators_data(symbols: List[str] = ["AAPL"], days: int = 30) -> pd.DataFrame:
        ...
        for symbol in symbols:
            ...
            symbol_data["bollinger_upper"] = symbol_data["close"].rolling(window=20).mean() + (
                symbol_data["close"].rolling(window=20).std() * 2
            )
            symbol_data["bollinger_lower"] = symbol_data["close"].rolling(window=20).mean() - (
                symbol_data["close"].rolling(window=20).std() * 2
            )
    ...
    @staticmethod
    def create_market_data(symbols: List[str] = ["AAPL", "MSFT", "GOOGL"], days: int = 30) -> Dict[str, pd.DataFrame]:
