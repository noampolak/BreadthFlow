#!/usr/bin/env python3
"""
Standalone Foundation Components Test Script

Tests the core foundation components without importing existing model modules
that may have PySpark dependencies.
"""
...
# Add the new modules to path
sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'model'))

# Import our new foundation components
from registry.component_registry import ComponentRegistry, ComponentMetadata
from config.configuration_manager import ConfigurationManager, ConfigSchema
from model.logging.error_handler import ErrorHandler, ErrorRecord
