...
class AutomatedFeatureEngineering:
    ...
    def __init__(self):
        ...
        self.config = {
            ...
            "tsfresh": {
                "default_fc_parameters": None,  # Use default
                "n_jobs": 1,
                "chunk_size": None
            },
            "feature_engine": {
    ...
    def engineer_features_automated(
        ...
        entity_id_column: str = "symbol",
        time_index_column: str = "date"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if self.libraries_available["tsfresh"] and TSFRESH_AVAILABLE:
                ...
                tsfresh_result = self._extract_tsfresh_features(
                    result_df, 
                    entity_id_column, 
                    time_index_column
                )
            ...
            if self.libraries_available["featuretools"] and FEATURETOOLS_AVAILABLE:
                ...
                featuretools_result = self._extract_featuretools_features(
                    result_df,
                    entity_id_column,
                    time_index_column
                )
            ...
            if self.libraries_available["feature_engine"] and FEATURE_ENGINE_AVAILABLE and target_column:
                ...
                selection_result = self._select_features_feature_engine(
                    result_df,
                    target_column
                )
    ...
    def _extract_featuretools_features(
        ...
        try:
            ...
            es = es.add_dataframe(
                ...
                logical_types={
                    entity_id_column: ft.variable_types.Categorical,
                    time_index_column: ft.variable_types.Datetime
                }
            )
            ...
            if not feature_matrix.empty:
                ...
                # Merge with original data
                result_df = featuretools_df.merge(
                    feature_matrix,
                    left_index=True,
                    right_index=True,
                    how='left'
    ...
    def _select_features_feature_engine(
        self, 
        df: pd.DataFrame, 
        target_column: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            k_best_selector = selection.SelectKBestFeatures(
                k=self.config["feature_engine"]["k_best"]
            )
