...
class SymbolManager:
    ...
    def _get_default_symbols(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "recommendations": {"quick_testing": "demo_small", "standard_demo": "demo_medium"},
        }
    ...
    def get_symbol_list(self, list_name: str) -> List[str]:
        ...
        if list_name not in symbols:
            ...
            raise ValueError(f"Symbol list '{list_name}' not found. " f"Available lists: {available_lists}")
    ...
    def get_recommended_list(self, use_case: str) -> str:
        ...
        if use_case not in recommendations:
            ...
            raise ValueError(f"Use case '{use_case}' not found. " f"Available cases: {available_cases}")
    ...
    def validate_symbols(self, symbols: List[str]) -> Dict[str, Any]:
        ...
        """
        if not symbols:
            return {"valid": False, "error": "Empty symbol list", "valid_symbols": [], "invalid_symbols": []}
    ...
    def create_custom_list(self, name: str, symbols: List[str], description: str = "") -> Dict[str, Any]:
        ...
        custom_list = {"name": name, "description": description, "symbols": validation["valid_symbols"]}
...
def get_demo_symbols(size: str = "medium") -> List[str]:
    ...
    size_mapping = {"small": "demo_small", "medium": "demo_medium", "large": "demo_large"}
