...
class FinancialFundamentals:
    ...
    @staticmethod
    def calculate_valuation_ratios(market_cap: Union[pd.Series, np.ndarray],
                                 earnings: Union[pd.Series, np.ndarray],
                                 book_value: Union[pd.Series, np.ndarray],
                                 sales: Union[pd.Series, np.ndarray]) -> Dict[str, pd.Series]:
    ...
    @staticmethod
    def calculate_profitability_ratios(revenue: Union[pd.Series, np.ndarray],
                                     net_income: Union[pd.Series, np.ndarray],
                                     total_assets: Union[pd.Series, np.ndarray],
                                     equity: Union[pd.Series, np.ndarray]) -> Dict[str, pd.Series]:
    ...
    @staticmethod
    def calculate_leverage_ratios(total_debt: Union[pd.Series, np.ndarray],
                                total_assets: Union[pd.Series, np.ndarray],
                                equity: Union[pd.Series, np.ndarray]) -> Dict[str, pd.Series]:
    ...
    @staticmethod
    def calculate_growth_metrics(current_values: Union[pd.Series, np.ndarray],
                               previous_values: Union[pd.Series, np.ndarray],
    ...
    @staticmethod
    def calculate_efficiency_ratios(revenue: Union[pd.Series, np.ndarray],
                                  total_assets: Union[pd.Series, np.ndarray],
                                  inventory: Union[pd.Series, np.ndarray],
                                  accounts_receivable: Union[pd.Series, np.ndarray]) -> Dict[str, pd.Series]:
    ...
    def get_all_fundamentals(fundamental_data: pd.DataFrame) -> pd.DataFrame:
        ...
        if 'revenue' in fundamental_data.columns:
            revenue_growth = FinancialFundamentals.calculate_growth_metrics(
                fundamental_data['revenue'],
                fundamental_data['revenue'].shift(4)  # YoY growth
            )
        ...
        if 'earnings' in fundamental_data.columns:
            earnings_growth = FinancialFundamentals.calculate_growth_metrics(
                fundamental_data['earnings'],
                fundamental_data['earnings'].shift(4)  # YoY growth
            )
