...
get_symbol_lists = SimpleHttpOperator(
    task_id='get_symbol_lists',
    http_conn_id='data_pipeline_http',
    endpoint='/symbol-lists',
    method='GET',
    dag=dag
)
...
get_storage_summary = SimpleHttpOperator(
    task_id='get_storage_summary',
    http_conn_id='data_pipeline_http',
    endpoint='/storage/summary',
    method='GET',
    dag=dag
)
...
log_completion = BashOperator(
    ...
    bash_command='echo "Data ingestion pipeline completed successfully at {{ ts }}"',
    dag=dag
)
