...
create_technical_indicators = PythonOperator(
    task_id='create_technical_indicators',
    python_callable=create_technical_indicators_func,
    dag=dag
)

# Task 3: Create time-based features
create_time_features = PythonOperator(
    task_id='create_time_features',
    python_callable=create_time_features_func,
    dag=dag
)

# Task 4: Create market microstructure features
create_microstructure_features = PythonOperator(
    task_id='create_microstructure_features',
    python_callable=create_microstructure_features_func,
    dag=dag
)
...
validate_features = SimpleHttpOperator(
    ...
    method='POST',
    data=json.dumps({
        'data_path': 'features/technical_indicators',
...
log_completion = BashOperator(
    ...
    bash_command='echo "Feature engineering pipeline completed successfully at {{ ts }}"',
    dag=dag
)
